...
!  parameter values (initial settings)
     ...
     &                                            'NO',                 &  !  MATER_VARIATION
     &                                            'NONAME',             &  !  AMV_FILENAME
     &                                            'POLYDE',             &  !  AMV_FILEFORMAT
     &                                            'CUBOID',             &  !  MATER_VARIATION_REGION_SHAPE
     &                                            'BoundaryConditions', &  !  BC_FILENAME
     &                                            'NO',                 &  !  EXPORT2MATLAB
     &                                            'SOLUTION_RESIDUAL',  &  !  PLOT_RESIDUALTYPE
     &                                            'NO',                 &  !  USE_AUX_SOLUTION
     &                                            'solution_aux',       &  !  AUX_SOLUTION_FILE
     &                                            'DPC'                 &  !  LINSYS_DATA_TYPE 
     &                                               /)
     ...
     &                                            0._DP,                &  !  24  AMV_CENTER_X
     &                                            0._DP,                &  !  25  AMV_CENTER_Y
     &                                            0._DP,                &  !  26  AMV_CENTER_Z
     &                                            0._DP,                &  !  27  AMV_RADIUS
     &                                            0._DP,                &  !  28  AMV_SIDE_X
     &                                            0._DP,                &  !  29  AMV_SIDE_Y
     &                                            0._DP,                &  !  30  AMV_SIDE_Z
...
!  Names of the parameters,                         alphabetic odering
     ...
     &                                               'AMV_FILENAME',      &
     &                                               'AMV_FILEFORMAT',    &
     &                                               'AMV_SHAPE',         & ! MATER_VARIATION_REGION_SHAPE
     &                                               'BC_FILENAME',       &
     &                                               'EXPORT2MATLAB',     &
     &                                               'PLOT_RESIDUALTYPE', &
     &                                               'USE_AUX_SOLUTION',  &
