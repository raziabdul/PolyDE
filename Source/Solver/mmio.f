...
c            complex (DPC) -> for Polyde (guitorri changed it)
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc      
c
c Declarations:
c
      use femtypes ! needed to match type
      integer ival(*) ! we don't use integer matrix
      double precision rval(*) !NOT COMPLIANT
      !complex cval(*) 
      complex (DPC) cval(*) ! changed to match Polyde 
      integer indx(*)
      integer jndx(*)
