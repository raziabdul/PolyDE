...
! Some Pardiso paramenters
    ...
    !waltime1 = omp_get_wtime()
    !$ print*,'max_threads =',omp_get_max_threads()  ! -> conditional compilation
...
!  Set  up  PARDISO  control  parameter
      ...
      !$ iparm(3) = omp_get_max_threads() !value  of  MKL_NUM_THREADS
...
!    WRITE(*,*) ''
!    WRITE(*,*) 'omp_max = ',omp_get_max_threads()
!    waltime2 = omp_get_wtime()
!    waltime2 = omp_get_wtime()
!    WRITE(*,*) 'Time ',waltime2-waltime1
